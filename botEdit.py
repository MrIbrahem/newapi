...
Bot_Cash = {}
# ---
stop_edit_temps = {'all': ['تحرر', 'قيد التطوير', 'يحرر'], 'fixref': ["لا لصيانة المراجع"], 'cat': ["لا للتصنيف المعادل"], 'stub': ["لا لتخصيص البذرة"], 'tempcat': ["لا لإضافة صناديق تصفح معادلة"], 'portal': ["لا لربط البوابات المعادل", 'لا لصيانة البوابات']}
